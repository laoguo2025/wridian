...
export const VENDOR_PRESETS: VendorPreset[] = [
  ...
  },
  {
    ...
    baseUrl: "",
    defaultEnvOverrides: {
      WRIDIAN_OPENAI_COMPAT_MAX_TOKENS_FIELD: "max_tokens",
      WRIDIAN_OPENAI_COMPAT_OMIT_TEMPERATURE: "false",
      WRIDIAN_OPENAI_COMPAT_THINKING: "",
    },
    defaultModels: [],
    fields: ["name", "api_key", "base_url", "model_names", "env_overrides"],
    bucket: "compatible",
    meta: { billingModel: "gateway" },
  },
  {
  ...
  },
  {
    ...
    defaultModels: [
      ...
      { modelId: "mimo-v2.5", upstreamModelId: "mimo-v2.5", displayName: "MiMo-V2.5" },
