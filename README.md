...
- 添加授权登录类入口：Claude、OpenAI / ChatGPT 可走授权登录；Gemini OAuth 需要本机配置 Google OAuth 客户端环境变量；国内和第三方服务继续支持 API Key。
...
- [release/Wridian-0.0.3-x64-setup.exe](release/Wridian-0.0.3-x64-setup.exe)

也可以从 GitHub Release 下载：

- [Wridian 0.0.3](https://github.com/laoguo2025/wridian/releases/tag/v0.0.3)
